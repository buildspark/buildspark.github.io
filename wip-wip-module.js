...
var WipPage = /** @class */ (function (_super) {
    ...
    WipPage.prototype.onViewWIPDateClicked = function () {
        ...
        this.wipNonPackReqModel.date = this.standardDateTime(this.wipNonPackReqModel.date);
        this.service.presentLoading(true);
        this.service.callWebService(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_3__["Constants"].k_HOURLY_WIP, this.wipPackReqModel, function (res) {
            if (res && res.data && res.data != '' && res.data != '-') {
                _this.arrDailyCharts = JSON.parse(res.data);
            }
