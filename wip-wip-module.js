...
var WipPage = /** @class */ (function (_super) {
    ...
    function WipPage(loadingCtrl, alertCtrl, service, storage, loadingController, modalController, router, route) {
        ...
        _this.wipReqModel = new _data_model_base_model__WEBPACK_IMPORTED_MODULE_4__["WIPModel"](1 /* WIP */);
        ...
        _this.storage.get(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_3__["Constants"].c_ACCESS_TOKEN).then(function (accessToken) {
            ...
            // });
            // if (this.data) {
            //   this.wipReqModel.dept = [];
            //   this.data.forEach(element => {
            //     if (element.isChecked) {
            //       this.wipReqModel.dept.push(element.dept.value)
            //     }
            //   });
            //   this.callWSToReloadPagesData();
            // }
    ...
    WipPage.prototype.ngOnInit = function () {
        ...
        //   config.log("GET DATA FROM PROCESS: ", JSON.stringify([this.wipReqModel]));
        //   this.callWSToReloadPagesData();
        // }
    };
    ...
    WipPage.prototype.callWSToReloadPagesData = function () {
        var _this = this;
        var response1 = this.service.callWebService(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_3__["Constants"].k_HOURLY_WIP, this.wipReqModel, function (res) {
            _this.arrDailyCharts = JSON.parse(res.data);
        });
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["forkJoin"])([response1]);
    };
    ...
    WipPage.prototype.onViewWIPDateClicked = function () {
        ...
        this.presentLoading();
        this.service.callWebService(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_3__["Constants"].k_HOURLY_WIP, this.wipReqModel, function (res) {
            _this.arrDailyCharts = JSON.parse(res.data);
            _this.dismissLoading();
        });
    };
    ...
    WipPage.prototype.downloadcsv = function () {
        var _this = this;
        this.presentAlert('Extract Data', 'Are you sure want to extract data as file to your local storage?', function (res) {
