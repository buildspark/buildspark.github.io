...
var OperatorPage = /** @class */ (function (_super) {
    ...
    OperatorPage.prototype.callWSToGetPreselectionData = function () {
        var _this = this;
        this.storage.get(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_OP_SEL_MACH).then(function (machine) {
            if (!(machine == undefined || machine == null)) {
                _this.strMachineName = machine.Machine;
                _this.transfileReqModel.machineid = machine.MachineID;
                _this.arrTransfile = [];
                ...
                _this.service.callWebService(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].k_GET_TRANSFILE, _this.transfileReqModel, function (res) {
                    ...
                    if (_this.arrTransfile && _this.arrTransfile.length > 0 && _this.arrTransfile[0].Status) {
                        ...
                        if (strMachineStatus.toLowerCase() == 'down') {
                            _this.presentAlert('Alert', 'Machine ' + _this.arrTransfile[0].Machine + ' is in ' + strMachineStatus + ' State. Do you want to continue to machine down detail page?', function (res) {
                                if (res.role == _data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].b_OK) {
                                    ...
                                    _this.service.callWebService(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].k_GET_ISSUE_MDOWN, _this.issueMachineDownReqModel, function (res) {
                                        if (res.status_code == 0 /* Success */) {
                                            ...
                                            if (_this.navCtrl.navigateForward('/operator/machine-down/downstart')) {
                                                _this.dismissLoading();
                                            }
                                        }
                                        else {
    ...
    OperatorPage.prototype.onResetClicked = function () {
        var _this = this;
        this.presentAlert('Alert', 'Are you sure want to reset?', function (res) {
            if (res.role = _data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].b_OK) {
                _this.resetField();
            }
        }, [_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].b_CANCEL, _data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].b_OK]);
    ...
    OperatorPage.prototype.onOptionClicked = function () {
        var _this = this;
        this.storage.get(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_OP_SEL_PROC).then(function (process) {
            _this.presentModal(process);
        });
    };
    OperatorPage.prototype.presentModal = function (process) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (dataReturned) {
                            ...
                            if (dataReturned !== null && dataReturned.data !== undefined) {
                                _this.transfileReqModel.machineid = dataReturned.data.MachineID;
                                _this.smsReqModel.machineid = dataReturned.data.MachineID;
                                _this.strMachineName = dataReturned.data.Machine;
                                _this.arrTransfile = [];
                                _this.presentLoading();
                                _this.service.callWebService(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].k_GET_TRANSFILE, _this.transfileReqModel, function (res) {
                                    _this.dismissLoading();
    ...
    OperatorPage.prototype.afterGetTransfile = function (response) {
        ...
        if (this.isMachineFound) {
            ...
            // this.storage.set(Constants.c_OP_SEL_DEPT, [this.arrTransfile[0].deptid]);
            // this.storage.set(Constants.c_OP_SEL_PROC, [this.arrTransfile[0].ProcessCode]);
            this.storage.set(_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_OP_SEL_MACH, { 'Machine': this.arrTransfile[0].Machine, 'MachineID': this.transfileReqModel.machineid });
        }
        else {
            if (this.isIdle) {
    ...
    OperatorPage.prototype.onMachineDownClicked = function () {
        ...
        if (this.statusColor == this.statusDown) {
            ...
            this.presentAlert('Alert', 'Are you sure want to issue down this machine?<br/><br/>' + this.arrTransfile[0].Machine, function (res) {
                if (res.role = _data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].b_OK) {
...
var SelDeptComponent = /** @class */ (function (_super) {
        ...
        this.storage.get(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_ACCESS_TOKEN).then(function (accessToken) {
            ...
            _this.service.callWebService(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].k_GET_DEPT, _this.deptReqModel, function (res) {
                if (res.status_code == 0 /* Success */) {
                    ...
                    _this.checkBoxList = [];
                    _this.storage.get(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_OP_SEL_DEPT).then(function (department) {
                        if (department == undefined || department == null) {
                            ...
                            var arrSelectedDept_1 = department;
                            _this.arrDept.forEach(function (element) {
                                _this.checkBoxList.push({
                                    'dept': element,
                                    'isChecked': arrSelectedDept_1.includes(element.value)
                                });
                            });
                        }
                        _this.checkEvent();
    ...
    SelDeptComponent.prototype.checkMaster = function () {
        var _this = this;
        setTimeout(function () {
    ...
    SelDeptComponent.prototype.checkEvent = function () {
    ...
    SelDeptComponent.prototype.navigateToSelProcess = function () {
        ...
        this.storage.set(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_OP_SEL_DEPT, arrSelectedDept);
        if (this.disableSelectButton()) {
            this.service.presentAlert('Alert', 'Please select at least one (1) department.');
        }
        else {
    ...
    SelDeptComponent.prototype.disableSelectButton = function () {
...
var SelMachineComponent = /** @class */ (function (_super) {
    ...
    SelMachineComponent.prototype.ngOnInit = function () {
        this.arrSelectedProcess = this.navParams.data.arrSelectedProcess;
        if (!(this.arrSelectedProcess == null || this.arrSelectedProcess == undefined || this.arrSelectedProcess.length == 0)) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // const onClosedData: string = "Wrapped Up!";
                    return [4 /*yield*/, this.modalCtrl.dismiss(this.machine)];
                    case 1:
                        // const onClosedData: string = "Wrapped Up!";
                        _a.sent();
                        return [2 /*return*/];
    ...
    SelMachineComponent.prototype.callWSGetMachine = function () {
        var _this = this;
        this.machineReqModel.process = this.arrSelectedProcess;
        this.storage.get(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_5__["Constants"].c_OP_MACHINE_LIST).then(function (arrMachineList) {
            if (arrMachineList == null || arrMachineList.length == 0) {
                _this.presentLoading();
                _this.storage.get(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_5__["Constants"].c_ACCESS_TOKEN).then(function (accessToken) {
                    ...
                    _this.service.callWebService(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_5__["Constants"].k_GET_MACHINE, _this.machineReqModel, function (res) {
                        if (res.status_code == 0 /* Success */) {
                            _this.arrMachine = JSON.parse(res.data);
                            _this.storage.set(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_5__["Constants"].c_OP_MACHINE_LIST, _this.arrMachine);
                        }
                        _this.dismissLoading();
                    });
                });
                ...
                _this.arrMachine = arrMachineList;
                _this.dismissLoading();
            }
        });
    };
    SelMachineComponent.prototype.onMachineClicked = function (machine) {
        ...
        this.storage.set(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_5__["Constants"].c_OP_SEL_MACH, this.machine);
        this.closeModal();
    };
...
var SelProcessComponent = /** @class */ (function (_super) {
    ...
    SelProcessComponent.prototype.checkMaster = function () {
        var _this = this;
        setTimeout(function () {
            _this.checkBoxList.forEach(function (obj) {
                obj.isChecked = _this.masterCheck;
    ...
    SelProcessComponent.prototype.checkEvent = function () {
        var totalItems = this.checkBoxList.length;
        var checked = 0;
        this.checkBoxList.map(function (obj) {
            if (obj.isChecked)
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // const onClosedData: string = "Wrapped Up!";
                    return [4 /*yield*/, this.modalCtrl.dismiss(this.checkBoxList)];
                    case 1:
                        // const onClosedData: string = "Wrapped Up!";
                        _a.sent();
                        return [2 /*return*/];
    ...
    SelProcessComponent.prototype.callWSGetProcess = function () {
        var _this = this;
        this.processReqModel.dept = this.arrSelectedDept;
        // if (this.disableSelectButton()) {
        //   this.service.presentAlert('Alert', 'Please select at least one (1) department.');
        // } else {
        // }
        this.storage.get(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_ACCESS_TOKEN).then(function (accessToken) {
            ...
            _this.service.callWebService(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].k_GET_PROCESS, _this.processReqModel, function (res) {
                ...
                _this.checkBoxList = [];
                _this.storage.get(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_OP_SEL_PROC).then(function (process) {
                    if (process == undefined || process == null) {
                        ...
                        var arrSelectedProc_1 = process;
                        _this.arrProcess.forEach(function (element) {
                            _this.checkBoxList.push({
                                'process': element,
                                'isChecked': arrSelectedProc_1.includes(element.value)
                            });
                        });
                    }
                    _this.checkEvent();
    ...
    SelProcessComponent.prototype.navigateToSelMachine = function () {
        ...
        this.storage.set(src_app_data_model_constant_model__WEBPACK_IMPORTED_MODULE_6__["Constants"].c_OP_SEL_PROC, arrSelectedProcess);
        if (this.disableSelectButton()) {
            this.service.presentAlert('Alert', 'Please select at least one (1) process.');
        }
        else {
            var nav = document.querySelector('ion-nav');
    ...
    SelProcessComponent.prototype.disableSelectButton = function () {
        var isCheckedAtLeastOne = false;
        this.checkBoxList.forEach(function (element) {
            if (element.isChecked) {
                isCheckedAtLeastOne = true;
