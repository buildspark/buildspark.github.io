        ...
        this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_6__["NavigationEnd"]) {
                ...
                if (arrPath.length > 2) {
                    ...
                    _this.backButtonSubscription = _this.platform.backButton.subscribeWithPriority(1, function () {
                        _this.presentAlert('Alert', 'Are you sure want to exit app?', function (res) {
...
/*!**********************************************!*\
  !*** ./src/app/data-model/constant.model.ts ***!
  \**********************************************/
/*! exports provided: Constants, config */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Constants = /** @class */ (function () {
    ...
    Constants.c_OP_SEL_DEPT = "OP_SEL_DEPT";
    Constants.c_OP_SEL_PROC = "OP_SEL_PROC";
    Constants.c_OP_SEL_MACH = "OP_SEL_MACH";
    Constants.c_OP_MACHINE_LIST = "OP_MACHINE_LIST";
...
var BaseService = /** @class */ (function (_super) {
    ...
    function BaseService(loadingCtrl, alertCtrl, navCtrl, http, ngxXml2jsonService, httpClient, plt) {
        ...
        _this.navCtrl = navCtrl;
        _this.http = http;
        _this.ngxXml2jsonService = ngxXml2jsonService;
                        ...
                        return [4 /*yield*/, this.http.sendRequest(url, {
                                ...
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    ...
                                    if (!resItem || !resItem.status_code || resItem.status_code != 0 /* Success */) {
                                        ...
                                        setTimeout(function () {
                                            _this.presentAlert(strCode_1, strMsg, function (res) {
...
var BasePagePage = /** @class */ (function () {
    ...
    BasePagePage.prototype.presentLoading = function () {
        // Dismiss all pending loaders before creating the new one
        this.dismissLoading();
        this.loadingCtrl.create().then(function (res) {
            res.present();
        });
    };
    /**
    ...
    */
    BasePagePage.prototype.presentAlert = function (header, message, callback, buttons, input) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, vm.alertCtrl.create({
                                header: header,
                                inputs: input,
                                subHeader: '',
                                message: message,
